...
if (isset($_POST['submit'])) {
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO tb_user (cod_user,nombre, apellido, cod_identificacion, puesto) values (:" . implode(", :", array_keys($usuario)) . ")";
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group">
          <label for="cod_user">Codigo</label>
          <input type="text" name="cod_user" id="cod_user" class="form-control">
        </div>
        <div class="form-group">
